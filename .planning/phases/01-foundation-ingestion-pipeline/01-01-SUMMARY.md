...
tags: [docker, fastapi, celery, sqlalchemy, pgvector, alembic, jwt, pyjwt, pbkdf2, pytest]
...
affects: [01-02, 01-03, 02-matching-engine, 03-review-merge-ui]

# Tech tracking
tech-stack:
  added: [fastapi, sqlalchemy, alembic, celery, redis, pgvector, pyjwt, pydantic-settings, sentence-transformers, pytest, httpx]
  patterns: [sync-sqlalchemy, pydantic-v2-schemas, oauth2-password-bearer, pbkdf2-sha256-hashing, service-layer-pattern, dependency-injection]
